...
exports.createToken = exports.sendEmail = void 0;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            oauth2Client.getAccessToken(function (error, token) {
                                if (error) {
                                    reject();
                                }
                                else {
...
var sendEmail = function (props) {
    return __awaiter(this, void 0, void 0, function () {
        var to, subject, text, transporter, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    to = props.to, subject = props.subject, text = props.text;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
...
var createToken = function () {
    return uuid_1.v4().toString().replace(/-/g, '');
};
