...
var getBooks = function () {
    ...
    describe("GET /books/new", function () {
        test_utils_1.getError("/books/new", "Should render 'Unauthorized Error' when attempting GET /books/new while not authenticated", global_constants_1.UNAUTH_REQ_ERR);
    });
    // @route   GET /books/:id
